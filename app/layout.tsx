...
export const metadata: Metadata = {
  ...
  description:
    "مشروع علم الروم من الديار القطرية شرق مرسى مطروح - مدينة ساحلية متكاملة على 5000 فدان باستثمارات 29.7 مليار دولار. المرحلة الأولى 2026. الأسعار الاسترشادية لمرحلة Sandside Lagoons تبدأ من 15.6 مليون جنيه. سجّل اهتمامك لتصلك القوائم الرسمية فور الإعلان.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "5000 فدان - استثمارات 29.7 مليار دولار - المرحلة الأولى 2026. الأسعار الاسترشادية تبدأ من 15.6 مليون جنيه - سجّل مبكراً لتصلك أنظمة السداد فور صدورها.",
    url: "/",
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "الأسعار الاسترشادية المتداولة لمرحلة Sandside Lagoons تبدأ من 15.6 مليون جنيه للشاليهات وتصل إلى 78.4 مليون جنيه للفلل المستقلة على اللاجون، مع مبالغ جدية حجز (EOI) تبدأ من 100 ألف جنيه للشاليهات. لم تصدر بعد أنظمة السداد الرسمية من المطور — سجّل اهتمامك لتصلك فور صدورها.",
      },
    },
    {
      "@type": "Question",
