...
export const metadata: Metadata = {
  ...
  description:
    "مشروع علم الروم من الديار القطرية شرق مرسى مطروح - مدينة ساحلية متكاملة على 5000 فدان باستثمارات 29.7 مليار دولار. المرحلة الأولى 2026. سجّل اهتمامك لتصلك الأسعار فور الإعلان الرسمي.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "5000 فدان - استثمارات 29.7 مليار دولار - المرحلة الأولى 2026. سجّل اهتمامك مبكراً لتكون أول من يعرف الأسعار وأنظمة السداد.",
    url: "/",
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "هل تم الإعلان عن أسعار الوحدات في علم الروم؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "لا، حتى الآن لم يتم الإعلان رسمياً عن أسعار الوحدات أو أنظمة السداد. المشروع في مرحلة ما قبل الإطلاق، ويمكنك تسجيل اهتمامك لتصلك الأسعار الرسمية فور صدورها.",
      },
    },
    {
      "@type": "Question",
